...
import com.qiyueqi.view.home.bean.Flow;
...
//    private ArrayList<ArrayList<CommonBean>> mData;
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = (int) typedArray.getDimension(R.styleable.FlowLayout_textSizes, 14) / 2;
     ...
     * @param data
     */
    public void setFlowData(ArrayList<CommonBean> data) {
        this.mData = data;
        View view = mLayoutInflater.inflate(R.layout.flow_layout, this);
    ...
    private void initView() {
        ...
        for (int i = 0; i < mData.size(); i++) {
            View itemView = mLayoutInflater.inflate(R.layout.flow_item, null);
            ...
            chk.setText(mData.get(i).getValue());
...
//				resetItemWidth(itemView, itemW);
    ...
    public void setDefaultSelectName(String selectName) {
        for (int i = 0; i < mData.size(); i++) {
            CommonBean propertyValuesJson = mData.get(i);
            if (propertyValuesJson.getValue().equals(selectName)) {
                notifyAllItemView(i);
                return;
            }
    ...
    public void setDefaultSelectId(String selectId) {
        for (int i = 0; i < mData.size(); i++) {
            CommonBean propertyValuesJson = mData.get(i);
            if (propertyValuesJson.getKey().equals(selectId)) {
                notifyAllItemView(i);
                return;
            }
        }
